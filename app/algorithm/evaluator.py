...
class CrossValidation(object):
    ...
    def KFold(self, data, recommender, simMeasure=None, nNeighbors=None, model=None, topN=TOP_N, nFolds=5):
        ...
        for fold in range(nFolds):
            ...
            evaluation = evaluateRecommender(testSet, recommender, simMeasure=simMeasure, nNeighbors=nNeighbors,
                                             model=model, topN=topN)
